...
core.register_cheat_setting("Aim only enemies", "Combat", "autoaim", "autoaim.aim_all", {type="bool"})
core.register_on_active_object_step(function(gcao)
    if minetest.settings:get_bool("autoaim.aim_all") == true then
        core.update_infotext("Autoaim", "Combat", "autoaim", "Enemies," .. core.settings:get("autoaim.distance"))
    else
        core.update_infotext("Autoaim", "Combat", "autoaim", "All," .. core.settings:get("autoaim.distance"))
    end
